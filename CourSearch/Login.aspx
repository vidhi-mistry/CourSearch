<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CourSearch.Login" %>
        ...
        <div class="col-sm-8 col-md-4 col-lg-4 mx-auto">
            ...
            <div class="card bg-transparent">
                ...
                <div class="card-body">
                    ...
                    <asp:TextBox ID="Email" runat="server"  class="form-control" placeholder="Email Address" OnTextChanged="Email_TextChanged"></asp:TextBox>                        
